...
import com.ensias.ebarber.adapter.ConfirmedAppointmentsAdapter;
...
public class ConfirmedAppointmensActivity extends BaseActivity implements AdapterListener {
    ...
    public void setUpRecyclerView(){
        ...
        adapter = new ConfirmedAppointmentsAdapter(options,this);
