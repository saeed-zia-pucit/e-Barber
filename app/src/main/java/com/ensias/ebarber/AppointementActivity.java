...
import com.ensias.ebarber.model.Hour;
...
public class AppointementActivity extends BaseActivity {
        ...
        for (int i = 8; i<19;i++){
            ...
            addRequest.document(i+"").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    ...
                    if(note != null){
                        btn.setText(getString(R.string.already_chosen));
                    }
                    else{
                        btn.setText(getString(R.string.confirm_this));
