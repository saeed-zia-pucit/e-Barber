...
public class SearchPatActivity extends BaseActivity implements DoctorAdapterFiltred.DoctorAdapterListener {
    ...
    private void setUpRecyclerView() {
        ...
        query.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                adapter = new DoctorAdapterFiltred(task.getResult().toObjects(Doctor.class),SearchPatActivity.this);
    ...
    private void configureToolbar(){
        ...
        toolbar.setTitle(getString(R.string.avaiable_salons));
