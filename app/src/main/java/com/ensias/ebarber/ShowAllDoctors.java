...
public class ShowAllDoctors extends BaseActivity  implements MyCallBack {
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private CollectionReference doctorRef = db.collection("Doctor");
    //private MyPatientsAdapter Patientadapter;
    private DoctorAdapterFilteredAdmin adapter;
...
//    public void setUpRecyclerViewPatient(){
//
...
//                .build();
//
//        Patientadapter = new MyPatientsAdapter(options);
//        //ListMyPatients
...
//    }
    private void setUpRecyclerView() {
        RecyclerView recyclerView = findViewById(R.id.showAllDocRecycle);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        query.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                adapter = new DoctorAdapterFilteredAdmin(task.getResult().toObjects(Doctor.class),getApplicationContext(),ShowAllDoctors.this);
    ...
    private void configureToolbar(){
        ...
        toolbar.setTitle(getString(R.string.barber_list));
        // Sets the Toolbar
