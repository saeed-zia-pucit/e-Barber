    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisplayImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(UploadReport.this, ImagesActivity.class);
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
          ...
          //  String emailId=FirebaseAuth.getInstance().getCurrentUser().getEmail().toString().split("@")[0];
            ...
            StorageReference storageReference2nd = storageReference.child(Storage_Path).child(emailId).child(System.currentTimeMillis() + "." + GetFileExtension(FilePathUri));
            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            databaseReference.child(emailId).child(ImageUploadId).setValue(imageUploadInfo);
                        }
                    })
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(UploadReport.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(UploadReport.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
