...
import com.ensias.ebarber.ChatActivity;
import com.ensias.ebarber.DossierMedical;
...
public class MyPatientAdapterAdmin extends FirestoreRecyclerAdapter<Patient, MyPatientAdapterAdmin.MyPatientsHolder> {
     ...
     * @param options
     */
    public MyPatientAdapterAdmin(@NonNull FirestoreRecyclerOptions<Patient> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull final MyPatientsHolder myPatientsHolder, int position, @NonNull final Patient patient) {
        ...
        myPatientsHolder.callBtn.setVisibility(View.GONE);
