...
public class ConfirmedAppointmentsAdapter extends FirestoreRecyclerAdapter<ApointementInformation, ConfirmedAppointmentsAdapter.ConfirmedAppointmentsHolder> {
    ...
    public ConfirmedAppointmentsAdapter(@NonNull FirestoreRecyclerOptions<ApointementInformation> options,AdapterListener listener) {
        super(options);
...
//        });
    ...
    public void onDataChanged() {
        super.onDataChanged();
       adapterListener.isRecordFound(true);
    }
