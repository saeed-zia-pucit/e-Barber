...
public class DoctorAdapterFiltred  extends RecyclerView.Adapter<DoctorAdapterFiltred.DoctoreHolder2> implements Filterable {
    ...
    public DoctorAdapterFiltred(List<Doctor> tubeList,DoctorAdapterListener doctorAdapterListener){
        mTubeList = tubeList;
...
//            }
//        });
        doctoreHolder.specialite.setText(doctor.getAdresse());
        ...
        doctoreHolder.appointemenBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // openPage(v.getContext(),doctor.getEmail());
                listener.barberCardClicked(doctor.getEmail());
  ...
  protected class DoctoreHolder2 extends RecyclerView.ViewHolder {
    ...
    private void openPage(Context wf,String email){
        Intent i = new Intent(wf, MyServicesActivity.class);
        i.putExtra("userType","Customer");
        i.putExtra("email",email);
        wf.startActivity(i);
    }
    public interface DoctorAdapterListener{
        public void barberCardClicked(String email);
