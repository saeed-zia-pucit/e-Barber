...
import com.ensias.ebarber.model.UploadImage;
...
public class EditProfilePatientActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pDatabaseRef = FirebaseDatabase.getInstance(getString(R.string.database_url)).getReference("DoctorProfile");
        ...
        selectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                openFileChooser();
               // startActivity(new Intent(EditProfilePatientActivity.this,UploadReport.class));
