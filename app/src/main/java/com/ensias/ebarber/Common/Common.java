...
public class Common {
    ...
    public static final String SHOW_NEAR_BY = "showNearBy";
    public static int step = 0;
    public static String CurreentDoctor = "testdoc@testdoc.com";
    public static String Currentaappointementatype;
    public static int currentTimeSlot = -1;
    public static int currentOrderPrice=0;
    public static String CurrentDoctorName = "";
    ...
    public static String SALON_TITLE = "";
