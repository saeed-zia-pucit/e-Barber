...
public class MyCalendarDoctorActivity extends BaseActivity implements ITimeSlotLoadListener {
    ...
    private void init() {
        ...
        alertDialog = new SpotsDialog.Builder().setCancelable(false).setContext(this).build();//.build();
